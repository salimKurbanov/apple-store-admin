    ...
    return (
        <div className="graphic">
            ...
            <div className="graphic_grid">
                <div className="day">
                    <div className="scale" style={{height: '100px'}}></div>
                    <div className="day_name">ПН</div>
                </div>
                <div className="day">
                    <div className="scale" style={{height: '200px'}}></div>
                    <div className="day_name">ВТ</div>
                </div>
                <div className="day">
                    <div className="scale" style={{height: '150px'}}></div>
                    <div className="day_name">СР</div>
                </div>
                <div className="day">
                    <div className="scale" style={{height: '143px'}}></div>
                    <div className="day_name">ЧТ</div>
                </div>
                <div className="day">
                    <div className="scale" style={{height: '110px'}}></div>
